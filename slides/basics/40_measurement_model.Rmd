...
- SEMs have a structural and a measurement model
- SM is the hypothesis
- MM is the connection with data

- There are several ways to do name constructs in PLS-SEM
...
Mode A (Correlation weights - reflective) and Mode B (regression weights - formative), reflective
Formative vs Composite
...
---
# How SEMinR PLots different Measurements
