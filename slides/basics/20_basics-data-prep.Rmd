...
While using mean replacement for missing data will likely not skew the results of your model, it might also make it more unlikely for you to find significant relationships.
